 ...
 * Filename:         esp_AP_server.c
 * Function:         void app_main(), static void start_dhcp_server(), static void initialise_wifi_in_ap(void), void tcp_server(void *pvParam), void printStationList(), void print_sta_info(void *pvParam)
 * Global Variables: static EventGroupHandle_t wifi_event_group, const int CLIENT_CONNECTED_BIT, const int CLIENT_DISCONNECTED_BIT, const int AP_STARTED_BIT
 *
 */
...
#define MESSAGE "<!DOCTYPE html><html><body><img src=\"projectwolf.jpg\" alt=\"projectwolf\" width=\"500\" height=\"450\"><form action=\"/action_page.php\"> SSID:<br><input type=\"text\" name=\"firstname\" value=\"Mickey\"> <br>Password:<br><input type=\"text\" name=\"lastname\" value=\"Mouse\"> <br><br><input type=\"submit\" value=\"Submit\"></form> </body></html>"
...
//Handler function for each WiFi event like station connected:
...
//Configuring ESP32 as Access Point:
...
//Print Station Information like IP address:
